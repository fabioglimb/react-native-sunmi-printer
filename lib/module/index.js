...
const SunmiPrinterModule = getTurboSunmiPrinterModule() ?? NativeModules.SunmiPrinter;
const SunmiScanModule = getTurboSunmiScanModule() ?? NativeModules.SunmiScanModule;
...
export let PrinterStyleKey = /*#__PURE__*/function (PrinterStyleKey) {
  // 文本倍宽
...
export let PrinterStyleValue = /*#__PURE__*/function (PrinterStyleValue) {
...
export let AlignValue = /*#__PURE__*/function (AlignValue) {
  AlignValue[AlignValue["LEFT"] = 0] = "LEFT";
  AlignValue[AlignValue["CENTER"] = 1] = "CENTER";
  AlignValue[AlignValue["RIGHT"] = 2] = "RIGHT";
  return AlignValue;
}({});
export const SunmiScan = effectiveSunmiScanModule;
export default effectiveSunmiPrinterModule;
