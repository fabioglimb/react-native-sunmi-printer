...
export interface Spec extends TurboModule {
    ...
    printColumnsText(texts: ReadonlyArray<string>, widths: ReadonlyArray<number>, aligns: ReadonlyArray<number>): void;
    printColumnsString(texts: ReadonlyArray<string>, widths: ReadonlyArray<number>, aligns: ReadonlyArray<number>): void;
    ...
    print2DCode(data: string, symbology: number, modulesize: number, errorlevel: number): void;
